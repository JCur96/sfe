...
downloaded with this package, however that data is currently proprietary so will
...
>>>>>>> 26f3eba425f5df91edb7e1e6b98bc43d20b50bf3
...
p <- ggplot(NHM_Pangolins, aes(x=binomial, y=Percent_overlap)) +
  ...
  stat_summary(fun.data = 'mean_sdl', fun.args = list(mult=1), geom = 'errorbar', color = 'black', width = 0.2) +
  stat_summary(fun.y = mean, geom = 'point', color = 'black', size = 7)
        # (margin = margin(t = 0, r = 20, b = 20, l = 0)))
p1 <- ggplot(NHM_Pangolins, aes(x=as.numeric(Decade), y=Percent_overlap)) +
  geom_point(size = 5)+
  xlab('Decade of Collection') +
...
# dataPlots <- cowplot::plot_grid(p, p1, p2, p3, labels= 'AUTO')
# print(dataPlots)
suppressMessages(ggsave(filename = '../output/figure5.pdf', plot = dataPlots, device = 'pdf', height = 10, width = 10))
```
To my eye both overlap and centroid-edge distance show species dependent patterns, 
whereas decade doesn't show any strong trends. However, I think it is still worth 
investigating the effect decade has on predicting both overlap and distance.
...
as a function of both decade and species, in four cases (REPORT STATS HERE). 
>>>>>>> 26f3eba425f5df91edb7e1e6b98bc43d20b50bf3
>>>>>>> 52f82e490c928d7cfcdb3184a18b9ab4cd8c8e2a
