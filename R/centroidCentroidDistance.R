#' Calculates the distance between the centroids of two convex hulls
#'
#' \code{centroidCentroidDistance} calculates the distance from the centroid of one
